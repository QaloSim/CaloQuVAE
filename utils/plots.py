...
def plot_histograms(ax, target, recon, xlabel, ylabel, title, bins=30, log_scale=True):
...
def vae_plots(incident_energies, target_showers, recon_showers):
    """
    ...
    plot_histograms(overall_ax[0, 0], target_energy_sums_np, recon_energy_sums_np, 
                            xlabel='Deposited Energy (GeV)', ylabel='Density', title="Overall Deposited Energy")
    plot_histograms(overall_ax[0, 1], target_incidence_ratio_np, recon_incidence_ratio_np, 
    ...
    plot_histograms(overall_ax[1, 1], target_sparsity_np, recon_sparsity_np,
    ...
    for i, energy_center in enumerate(energy_bin_centers):
        ...
        plot_histograms(ax_energy_sum[row, col], target_energy_sums_e, recon_energy_sums_e, 
                                xlabel='Deposited Energy (GeV)', ylabel='Density',
                                title=f'Energy ~ {e_low / 1000:.1f} - {e_high / 1000:.1f} GeV')
        plot_histograms(ax_incidence_ratio[row, col], target_incidence_ratio_e, recon_incidence_ratio_e,
        ...
        plot_histograms(ax_sparsity[row, col], target_sparsity_np[mask], recon_sparsity_np[mask],
