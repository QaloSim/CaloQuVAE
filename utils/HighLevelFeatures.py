...
class HighLevelFeatures:
    ...
    def _DrawSingleLayer(self, data, layer_nr, filename, title=None, fig=None, subplot=(1, 1, 1),
        ...
        if fig is None:
            fig = plt.figure(ffigsize=(2, 2), dpi=200)
        num_splits = 400
        max_r = 0
    ...
    def _DrawShower(self, data, filename, title, _vmax, _vmin, _cmap='rainbow'):
    ...
    def DrawSingleShower(self, data, filename=None, title=None, vmax=0, vmin=0, cmap='rainbow'):
